...
def add_image(doc, img_name, width_inches=5.5, caption=''):
    """插入图片，居中显示"""
...
# 插入训练曲线图
add_image(doc, 'training_curve.png', width_inches=5.5, caption='图1: 训练Loss与准确率曲线（30 Epochs）')
...
# 插入混淆矩阵图和各类别准确率
add_image(doc, 'confusion_matrix.png', width_inches=5.0, caption='图2: 混淆矩阵（测试集480张，准确率97.08%）')
add_image(doc, 'class_accuracy.png', width_inches=5.0, caption='图3: 各类别测试准确率')

# 插入Web界面截图
add_image(doc, 'web_camera.png', width_inches=5.0, caption='图4: 摄像头实时识别界面')
add_image(doc, 'web_upload.png', width_inches=5.0, caption='图5: 图片上传识别界面')
...
add_image(doc, 'github_repo.png', width_inches=5.0, caption='图6: GitHub代码仓库')
